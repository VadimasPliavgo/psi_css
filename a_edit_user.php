    ...
    <style>
        ...
        <div style="text-align: center;">
            ...
            <form method="post" class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                Vartotojo Vardas:<br>
                <input type="text" class="form-control" value="<?php echo $row['username']; ?>" disabled><br>
                Įmonės Pavadinimas:<br>
                <input type="text" class="form-control" value="<?php echo $row['company_name']; ?>" disabled><br>
                <div>
                Aktyvus:<br>
