...
<tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if($row['status']== 'Uzklausa')
                        echo "<td><a href='a_edit_order.php?id=".$row['id']."'>Redaguoti</a></td>";
					else if($row['status']== 'Patvirtinta')
                        echo "<td><a href='a_assign_driver.php?id=".$row['id']."'>Priskirti Vairuotoją</a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
