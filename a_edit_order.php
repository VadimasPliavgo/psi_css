...
if ($_SESSION['admin'] == false)
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE orders SET price = $price ,status = 'Uzsakymui reikalingas patvirtinimas' WHERE id = $id";
    ...
    <br/><br/><br/>
        ...
        <div style="text-align: center;">
            ...
            <form method="post"  class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                Kaina €:<br>
                <input type="number" min="0" oninput="this.value = Math.abs(this.value)" class="form-control" name="price" value="<?php echo $row['price']; ?>" ><br>
                Statusas:<br>
